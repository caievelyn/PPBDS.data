...
Let's say you are trying to create a function, `flip_coins()`, that takes an input `n` of the number of coins to flip and adds up the number of Heads and Tails.

Let's start by creating a minimally viable function that flips one coin once and prints out `r "H"` or `r "T"`
